...
public class MainActivity extends BaseActivity implements OnGetGeoCoderResultListener {
    ...
    private void initView() {
        ...
        FabAttributes collection = new FabAttributes.Builder()
                ...
                .setSrc(getResources().getDrawable(R.mipmap.ic_user))
        ...
        FabAttributes email = new FabAttributes.Builder()
                .setBackgroundTint(Color.parseColor("#2096F3"))
                .setSrc(getResources().getDrawable(R.mipmap.ic_search))
                .setFabSize(FloatingActionButton.SIZE_AUTO)
                .setPressedTranslationZ(10)
                .setTag(2)
                .build();
        FabAttributes news = new FabAttributes.Builder()
                .setBackgroundTint(Color.parseColor("#2096F3"))
                .setSrc(getResources().getDrawable(R.mipmap.ic_more))
                .setFabSize(FloatingActionButton.SIZE_AUTO)
                .setPressedTranslationZ(10)
                .setTag(3)
                .build();
    ...
    public void onGetReverseGeoCodeResult(ReverseGeoCodeResult result) {
        ...
        baiduMap.addOverlay(
                new MarkerOptions()
                        ...
                        .icon(BitmapDescriptorFactory.fromResource(R.mipmap.icon_gcoding))  //图标
